...
public class EhcacheConfig {
    ...
    public net.sf.ehcache.config.Configuration ehcacheConfig(){
     ...
     */
    @Bean
    public CacheManager cacheManagerByConfiguration(){
    ...
    */
    ...
    @Bean
    public EhCacheCacheManager ehCacheCacheManager(@Qualifier("cacheManagerByConfiguration") CacheManager cacheManager){
        EhCacheCacheManager ehCacheCacheManager = new EhCacheCacheManager();
        ehCacheCacheManager.setCacheManager(cacheManager);
        return ehCacheCacheManager;
    }
